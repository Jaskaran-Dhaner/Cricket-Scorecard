 ...
 * @author sai
 */
public class selectBowler2 extends javax.swing.JFrame {
    
    String CurBowler = "";
    static String name,id,Bruns,Wicket,Overs,Econ,Maidens;
    /**
     * Creates new form selectBowler2
     */
    public selectBowler2() {
        initComponents();
    }
    ...
    private void selectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectActionPerformed
        ...
        //        secondInnings frames = new secondInnings();
        //        frames.setVisible(true);
        secondInnings.currentBowler.setText(CurBowler);
        //        BowlStats.BowlStats
        secondInnings.curBowlerEconomy.setText(selectBowler2.Econ);
        secondInnings.curBowlerMaidens.setText(selectBowler2.Maidens);
        secondInnings.curBowlerOver.setText(selectBowler2.Overs);
        secondInnings.curBowlerRun.setText(selectBowler2.Bruns);
        secondInnings.curBowlerWickets.setText(selectBowler2.Wicket);
        dispose();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try{
            ...
            String bowlingTeam = firstInningBat.getBatTeam1();
//            System.out.println(bowlingTeam);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selectBowler2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new selectBowler2().setVisible(true);
            }
        });
    }
